...
declare interface Props {
  ...
  /**
   * Callback that will be executed with the card latest location. It will be called with a Location object with the card x and y position. Use it to add animations to the card.
   */
  onCardLocationChange?: Location;
